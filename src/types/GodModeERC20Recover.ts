...
export interface GodModeERC20RecoverInterface extends utils.Interface {
  contractName: "GodModeERC20Recover";
  functions: {
...
export interface GodModeERC20Recover extends BaseContract {
  contractName: "GodModeERC20Recover";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GodModeERC20RecoverInterface;
