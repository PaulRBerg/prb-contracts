...
export interface OrchestratableInterface extends utils.Interface {
  contractName: "Orchestratable";
  functions: {
...
export interface Orchestratable extends BaseContract {
  contractName: "Orchestratable";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OrchestratableInterface;
